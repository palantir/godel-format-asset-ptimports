...
func TestVendorGrouper(t *testing.T) {
	grouper := newVendoredGrouper("github.com/palantir/go-ptimports/")
	...
	for i, currCase := range []struct {
		...
		{path: "github.com/palantir/go-ptimports", group: 2},
		{path: "github.com/palantir/go-ptimports/ptimports", group: 2},
	} {
